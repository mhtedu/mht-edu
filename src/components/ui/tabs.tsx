...
>(({ className, value, onClick, disabled, ...props }, ref) => {
  ...
  return (
    <View
      ...
      onClick={handleClick}
      className={cn(
        "items-center justify-center whitespace-nowrap rounded-sm px-3 py-1 text-sm font-medium ring-offset-background transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
